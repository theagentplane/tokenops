...
os.environ.setdefault("TOKENOPS_CONFIG", "src/tokenops/config/triad.yaml")
...
def main() -> int:
    ...
    _start_server("bench.servers.writer")
    print("Starting researcher server...")
    _start_server("bench.servers.researcher")
    print("Starting planner server...")
    _start_server("bench.servers.planner")

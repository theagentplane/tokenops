...
from tokenops.control import ApplyControls, Governor, Halt, Ledger, wrap_complete
...
def test_retry_recovers_from_degenerate_output():
    ...
    assert scripted.calls[2]["max_output_tokens"] < (
        scripted.calls[1]["max_output_tokens"] or 10**9
    )

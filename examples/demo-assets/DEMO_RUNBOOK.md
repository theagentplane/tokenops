...
**Agent:** Research → Summarize (A2A), `examples/agents/`  
...
| # | Slide | Live / asset |
|---|-------|----------------|
| 1 | Problem — multi-agent runs overspend when each agent has its own budget view | `docs/assets/tokenops-planes.png` |
| 2 | Architecture — two agents, one control plane, shared ledger | `examples/demo-assets/architecture/` |
